...
var _InsertLinkModal = _interopRequireDefault(require("../InsertLinkModal"));
var hooks = _interopRequireWildcard(require("./hooks"));
var _messages = _interopRequireDefault(require("./messages"));
require("./customTinyMcePlugins/embedIframePlugin");
var _jsxRuntime = require("react/jsx-runtime");
const _excluded = ["editorType", "editorRef", "disabled", "id", "courseId", "editorContentHtml", "assets", "isLibrary", "lmsEndpointUrl", "studioEndpointUrl", "onChange"];
...
const TinyMceWidget = _ref => {
  ...
  const translations = hooks.useTranslations(_messages.default);
  const {
    isImgOpen,
    openImgModal,
    closeImgModal
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactRedux.Provider, {
    ...
    }, imageSelection)), isInsertLinkOpen && /*#__PURE__*/(0, _jsxRuntime.jsx)(_InsertLinkModal.default, {
      isOpen: isInsertLinkOpen,
      onClose: closeInsertLinkModal,
      courseId: courseId,
      editorRef: editorRef,
      lmsEndpointUrl: lmsEndpointUrl
    }), editorType === 'text' ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_SourceCodeModal.default, {
...
const mapStateToProps = state => ({
  ...
  courseId: _redux.selectors.app.learningContextId(state)
});
