...
const ScoringCard = _ref => {
  ...
  const getScoringSummary = (weight, attempts, unlimited, gradingMethod) => {
    ...
    if (isGradingMethodEnabled) {
      summary += ` ${String.fromCharCode(183)} `;
      summary += intl.formatMessage(_messages.default.gradingMethodSummary, {
        gradingMethod: intl.formatMessage(_problem.GradingMethod[gradingMethod])
      });
    }
    return summary;
  };
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_SettingsOption.default, {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      className: "mb-4",
      children: [isGradingMethodEnabled && /*#__PURE__*/(0, _jsxRuntime.jsx)(_i18n.FormattedMessage, _objectSpread({}, _messages.default.scoringSettingsLabelWithGradingMethod)), !isGradingMethodEnabled && /*#__PURE__*/(0, _jsxRuntime.jsx)(_i18n.FormattedMessage, _objectSpread({}, _messages.default.scoringSettingsLabel))]
    }), isGradingMethodEnabled && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_paragon.Form.Group, {
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_paragon.Form.Control, {
        as: "select",
        value: scoring.gradingMethod,
        onChange: handleGradingMethodChange,
        floatingLabel: intl.formatMessage(_messages.default.scoringGradingMethodInputLabel),
        children: Object.values(_problem.GradingMethodKeys).map(gradingMethod => {
          const optionDisplayName = _problem.GradingMethod[gradingMethod];
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_i18n.FormattedMessage, _objectSpread({}, _messages.default.gradingMethodHint))
      })]
